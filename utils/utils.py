...
CAPTION_PROMPT = [
    DEFAULT_IMAGE_TOKEN + " " + "Can you  discribe this image? ",
    DEFAULT_IMAGE_TOKEN + " " + "What does this image discribe? ",
    DEFAULT_IMAGE_TOKEN + " " + "Please show us this image in detail."
]
